...
?>
    ...
    echo $accent_color; ?> ; }
    .button, input[type="submit"],#submit,.wpcf7-submit,.action-icon.normal:after,.action-icon.normal:hover,.social-icon-container .social-icon:hover,.main-footer a.tag:hover,.pagination .current,.pagination>.active>a, .pagination>.active>span, .pagination>.active>a:hover, .pagination>.active>span:hover, .pagination>.active>a:focus, .pagination>.active>span:focus, .main-navigation .navbar-toggle,.trivoo-gallery .trivoo-gallery-thumb .fa, .sticky-post-label { background-color: <?php
    echo $accent_color; ?> ; }
    ...
    .button:hover, input[type="submit"]:hover, input[type="submit"]:active, #submit:hover, .wpcf7-submit:hover, #submit:active, .wpcf7-submit:active, .button-:active  { -webkit-box-shadow: 0 0 5px $accent_shade_color; box-shadow: 0 0 5px $accent_shade_color; background: <?php
    echo $accent_shade_color; ?> ; }
