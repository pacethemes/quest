...
if ( !class_exists( 'Trivoo_Customize' ) ):
  ...
  /**
   * Returns an instance of the Trivoo_Customize class, creates one if an instance doesn't exist. Implements Singleton pattern
   *
   * @return Trivoo_Customize
   */
...
?>
  ...
  public static function LivePreview() {
    ...
    //wp_enqueue_script( 'trivoo-customizer-preview', get_template_directory_uri() . '/inc/customizer/assets/js/customizer-preview.js', array(  'jquery' ), '', true );
  ...
  public function EnqueueScripts() {
    ...
    wp_enqueue_script( 'trivoo-customizer', get_template_directory_uri() . '/inc/customizer/assets/js/customizer.js', array(), '', true );
  ...
  public function EnqueueFonts() {
    $mods = trivoo_get_mods();

    $fonts = array_intersect_key( $mods, array_flip( array_filter( array_keys( $mods ), 'trivoo_is_font_family' ) ) );
    $used_fonts = array();
    $defaults = array_keys( trivoo_get_standard_fonts() );

    foreach ( $fonts as $key => $value ) {
      if ( trivoo_string_ends_with( $key, '_family' ) && trim( $value ) !== "" && !in_array( $value, $defaults ) ) {
        $variant = trivoo_get_default_mod( str_replace( '_family', '_variant', $key ), $fonts );
  ...
  public static function PrintCss() {
    ...
    $mods = trivoo_get_mods();
    $colors = array_intersect_key( $mods, array_flip( array_filter( array_keys( $mods ), 'trivoo_get_color_mods' ) ) );

    $accent_color = trivoo_get_default_mod( 'colors_global_accent', $colors );
    $accent_shade_color = trivoo_get_default_mod( 'colors_global_accent_shade', $colors );
    $border_color = trivoo_get_default_mod( 'colors_global_border', $colors );

    $title_text = trivoo_get_default_mod( 'colors_title_text', $colors );

    $footer_text = trivoo_get_default_mod( 'colors_footer_text', $colors );
?>
    ...
    echo $accent_color; ?> ; }
    span a:hover,h1 a:hover,h2 a:hover,h3 a:hover,h4 a:hover,h5 a:hover,h6 a:hover,p a:hover,a:hover,a.tag:hover,.entry-content strong,.pagination a,.pagination.post-pagination a:hover,.action-icon.normal, .pagination>li>a:hover, .pagination>li>span:hover, .pagination>li>a:focus, .pagination>li>span:focus { color: <?php
    echo $accent_shade_color; ?> ; }
    .button:hover, #submit:hover, .wpcf7-submit:hover, #submit:active, .wpcf7-submit:active, .button-:active  { -webkit-box-shadow: 0 0 5px $accent_shade_color; box-shadow: 0 0 5px $accent_shade_color; background: <?php
    echo $accent_shade_color; ?> ; }
    ...
    echo trivoo_get_default_mod( 'colors_global_alt', $colors ); ?> ;  }
    ...
    echo trivoo_get_default_mod( 'colors_global_heading', $colors ); ?> ; }
    body {color: <?php
    echo trivoo_get_default_mod( 'colors_global_text', $colors ); ?> ; }
    ...
    echo trivoo_get_default_mod( 'colors_global_text_alt', $colors ); ?> ; }

    .boxed { background-color: <?php
    echo trivoo_get_default_mod( 'colors_global_site_bg', $colors ); ?> ; }
    #content { background-color: <?php
    echo trivoo_get_default_mod( 'colors_global_content_bg', $colors ); ?> ; }

    .main-header{ background-color: <?php
    echo trivoo_get_default_mod( 'colors_header_bg', $colors ); ?> ; border-color: <?php
    echo trivoo_get_default_mod( 'colors_header_border', $colors ); ?> ; }
    .main-header, .main-header a{ color: <?php
    echo trivoo_get_default_mod( 'colors_header_text', $colors ); ?> ; }
    .main-navigation .nav > li > a { color: <?php
    echo trivoo_get_default_mod( 'colors_menu_text', $colors ); ?> ; }
    .main-navigation .nav > li:hover > a { color: <?php
    echo trivoo_get_default_mod( 'colors_menu_hover', $colors ); ?> ; }
    .main-navigation .nav .dropdown-menu a { color: <?php
    echo trivoo_get_default_mod( 'colors_menu_sub_text', $colors ); ?> ; }
    .main-navigation .nav .dropdown-menu li:hover > a { color: <?php
    echo trivoo_get_default_mod( 'colors_menu_sub_hover', $colors ); ?> ; }
    .main-navigation .nav .dropdown-menu { border-color: <?php
    echo trivoo_get_default_mod( 'colors_menu_sub_border', $colors ); ?>  ; background-color: <?php
    echo trivoo_get_default_mod( 'colors_menu_sub_bg', $colors ); ?> ; }
    ...
    echo trivoo_get_default_mod( 'colors_menu_sub_hover_bg', $colors ); ?> ; color: <?php
    echo trivoo_get_default_mod( 'colors_menu_sub_hover', $colors ); ?> ; }

    #title-container { background-color: <?php
    echo trivoo_get_default_mod( 'colors_title_bg', $colors ); ?> ; color: <?php
    echo $title_text; ?> ; border-color: <?php
    echo trivoo_get_default_mod( 'colors_title_border', $colors ); ?> ; }
    #title-container h3 { color: <?php
    echo $title_text; ?> ; }

    .main-footer{ background-color: <?php
    echo trivoo_get_default_mod( 'colors_footer_bg', $colors ); ?> ; color: <?php
    echo $footer_text; ?> ; }
    .main-footer h1 { color: <?php
    echo trivoo_get_default_mod( 'colors_footer_heading', $colors ); ?> ;}
    .main-footer p, .main-footer li { color: <?php
    echo $footer_text; ?> ; }
    .main-footer, .main-footer li, .main-footer li:last-child { border-color: <?php
    echo trivoo_get_default_mod( 'colors_footer_border', $colors ); ?> ; }
    .copyright{ background-color: <?php
    echo trivoo_get_default_mod( 'colors_footer_sc_bg', $colors ); ?> ; color: <?php
    echo trivoo_get_default_mod( 'colors_footer_sc_text', $colors ); ?> ; }
    .social-icon-container .social-icon { color: <?php
    echo trivoo_get_default_mod( 'colors_footer_sc_si', $colors ) ?>; }
    .social-icon-container .social-icon:hover { color: <?php
    echo trivoo_get_default_mod( 'colors_footer_sc_si_hover', $colors ); ?>; background-color: <?php
    echo trivoo_get_default_mod( 'colors_footer_sc_si_hover_bg', $colors ); ?>;}


    /* Typography */
    body, .tooltip { <?php
    trivoo_font_settings( 'typography_global', $mods ) ?> }
    h1 { <?php
    trivoo_font_settings( 'typography_heading_h1', $mods ) ?> }
    h2 {  <?php
    trivoo_font_settings( 'typography_heading_h2', $mods ) ?> }
    h3 { <?php
    trivoo_font_settings( 'typography_heading_h3', $mods ) ?> }
    h4 {  <?php
    trivoo_font_settings( 'typography_heading_h4', $mods ) ?> }
    h5 { <?php
    trivoo_font_settings( 'typography_heading_h5', $mods ) ?> }
    h6 {  <?php
    trivoo_font_settings( 'typography_heading_h6', $mods ) ?> }
    .main-navigation .nav > li > a  {  <?php
    trivoo_font_settings( 'typography_menu', $mods ) ?> }
    .main-navigation .nav .dropdown-menu li a {  <?php
    trivoo_font_settings( 'typography_menu_sub', $mods ) ?> }
    .site-title { <?php
    trivoo_font_settings( 'typography_site_title', $mods ) ?> }
    .site-description { <?php
    trivoo_font_settings( 'typography_site_tagline', $mods ) ?> }
    #title-container ul li{ line-height: <?php
    echo trivoo_get_default_mod( 'typography_heading_h3_font_size', $mods ) * trivoo_get_default_mod( 'typography_heading_h3_line_height', $mods ) ?>px; }
    .main-sidebar .sidebar-widget { <?php
    trivoo_font_settings( 'typography_sidebar_body', $mods ) ?> }
    .main-sidebar .sidebar-widget .widget-title { <?php
    trivoo_font_settings( 'typography_sidebar_title', $mods ) ?> }
    .main-sidebar { <?php
    trivoo_font_settings( 'typography_footer_body', $mods ) ?> }
    .main-footer h1, .main-footer h2, .main-footer h3 { <?php
    trivoo_font_settings( 'typography_footer_title', $mods ) ?> }
    .copyright { <?php
    trivoo_font_settings( 'typography_footer_text', $mods ) ?> }
    <?php
    $site_bg = esc_url( trivoo_get_default_mod( 'bgimages_global_site', $mods ) );
    $title_bg = esc_url( trivoo_get_default_mod( 'bgimages_global_title_container', $mods ) );
    if ( $site_bg !== '' ): ?>
