		...
		<div id="upgrade_message" class="quest-plus-message">
			<p>
				...
				<a href="<?php echo self::$QUEST_PLUS_URI; ?>"
				   target="_blank"><?php _e( 'Upgrade to Quest Plus', 'quest' ); ?></a> <?php _e( 'and get pre built layouts and the ability save/load any layout.', 'quest' ); ?>
			</p>
		</div>
		...
		*/
		...
		<script type="text/template" id="pt-pb-section-template">
			...
			<div class="pt-pb-content-wrap">
				<div
					class="pt-pb-column-edit <%=  (_.isArray(content) || content.attributes !== undefined) ? 'hidden' : ''  %>">
					<a href="#" class="edit-columns" title="<?php _e( 'Edit Columns', 'quest' ); ?>"><i
							class="fa fa-columns"></i></a></div>
				<div class="pt-pb-content clearfix">
					...
					<div class="quest-plus-message">
						<strong><?php _e( 'Need more section options ?', 'quest' ); ?> <span class="quest-plus">Quest Plus</span>
						</strong> <br/>
						<a href="<?php echo self::$QUEST_PLUS_URI; ?>"
		...
		<script type="text/template" id="pt-pb-module-slider-template">
			...
			<div class="slider-container clearfix">
				<div class="pt-pb-column-edit ">
					<a href="#" class="pt-pb-settings pt-pb-settings-slider"
					   title="<?php _e( 'Slider Settings', 'quest' ) ?>"><i class="dashicons dashicons-images-alt"></i></a>
				</div>
		...
		<script type="text/template" id="pt-pb-module-slider-edit-template"
		        data-title="<?php _e( 'Slider Settings', 'quest' ); ?>">
		...
		<script type="text/template" id="pt-pb-module-slide-template">
			...
			<div class="pt-pb-column-content">
				...
				<%= bg_image != '' ? 'style="background-image:url(' + bg_image + ');"' : void 0 %>>
				<% if (bg_image == "") { %>
		...
		<script type="text/template" id="pt-pb-module-slide-edit-template"
		        data-title="<?php _e( 'Edit Slider', 'quest' ); ?>">
		...
		<script type="text/template" id="pt-pb-module-gallery-template">
			...
			<div class="gallery-container clearfix">
				<div class="pt-pb-column-edit ">
					<a href="#" class="pt-pb-settings pt-pb-settings-gallery"
					   title="<?php _e( 'Gallery Settings', 'quest' ) ?>"><i
		...
		<script type="text/template" id="pt-pb-module-gallery-edit-template"
		        data-title="<?php _e( 'Gallery Settings', 'quest' ); ?>">
		...
		<script type="text/template" id="pt-pb-module-image-edit-template"
		        data-title="<?php _e( 'Edit Image', 'quest' ); ?>">
			<h2><?php _e( 'Edit Image', 'quest' ); ?></h2>
			<div class="edit-content">
				<form>
					<div class="pt-pb-option">
		...
		<script type="text/template" id="pt-pb-module-text-edit-template"
		        data-title="<?php _e( 'Edit Text', 'quest' ); ?>">
			<h2><?php _e( 'Edit Image', 'quest' ); ?></h2>
			<div class="edit-content">
				<form>
		...
		<script type="text/template" id="pt-pb-module-hovericon-edit-template"
		        data-title="<?php _e( 'Edit Hover Icon', 'quest' ); ?>">
